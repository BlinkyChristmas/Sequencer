...
extension NSPasteboard.PasteboardType {
    static var sequenceEffect:NSPasteboard.PasteboardType {
        return NSPasteboard.PasteboardType("sequenceEffect")
    }
}
...
struct BlinkyGlobals {
    ...
    static let infoWidth = 160.0

    static let infoFontSize = 13.0
    static let detailFontSize = 10.0
    
    static let dotsPerSecond = 170.0
    static let startingLayerCount = 5

    static let backgroundColor = NSColor.black
    static let borderColor = NSColor.darkGray
    static let selectionColor = NSColor.lightGray
    static let timeNowColor = NSColor.green
    static let detailFontColor = NSColor.black
    ...
    static let scratchGridColor = NSColor.darkGray
